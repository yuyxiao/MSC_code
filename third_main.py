...
def test_all_possible_part1(lower_part1=-8388586, upper_part1=-2147483648):
    ...
    for loop_value in range(lower_part1, upper_part1, -10):
        gc.collect()
...
def write_file(x):
    global result
    with open('third_main/example13.txt', 'w') as f:
...
if __name__ == '__main__':
    ...
    test_all_possible_part1(-1979979326, -2147483648)
    gc.collect()
